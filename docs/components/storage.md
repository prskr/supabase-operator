...
```yaml title="Upstream S3 'Storage' example" linenums="1"
--8<-- "config/samples/supabase_v1alpha1_storage.yaml"
```
...
```yaml title="Local volume 'Storage' example" linenums="1"
--8<-- "config/samples/supabase_v1alpha1_storage_file_backend.yaml"
```
