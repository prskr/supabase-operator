...
The Realtime service of Supabase is not yet implemented.

### Supavisor

The Supavisor (connection pooler) is currently not implemented.
It is not yet decided whether this will be added at any point in the future.
